...
/* harmony import */ var _modules_demo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/demo */ "./src/modules/demo.js");
...
/* harmony import */ var _modules_searchCode__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/searchCode */ "./src/modules/searchCode.js");
...
(0,_modules_demo__WEBPACK_IMPORTED_MODULE_1__["default"])(); //pasto kodo paieskos app

(0,_modules_renderForm__WEBPACK_IMPORTED_MODULE_2__["default"])();
(0,_modules_searchCode__WEBPACK_IMPORTED_MODULE_3__["default"])();
...
var Demo = function Demo() {
  ...
  console.log('nav'); //norint perkelti scripta i <head> naudojam async(neuztikrina eiliskumo)
  ...
  var movies = function movies() {
    var data = fetch('http://www.omdbapi.com/?i=tt3896198&apikey=18c1a865&t=matrix').then(function (res) {
      return res.json();
    });
    return data;
  };
